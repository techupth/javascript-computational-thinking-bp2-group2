...
// Start coding here
let totalOrderFromBirdieShepland = 0;
for(let i = 0; i < orders.length; i++) {
  if(orders[i].customerName === "Birdie Shepland") {
    totalOrderFromBirdieShepland += orders[i].productPrice * orders[i].productQuantity;
  }
}
console.log(`Total paid amount of Birdie Shepland: ${totalOrderFromBirdieShepland} Baht`);